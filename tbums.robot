...
Підготувати клієнт для користувача
    ...
    Run Keyword If    '${username}' != 'tbums_Viewer'    Login    ${username}
...
Завантажити документ
    ...
    ...    ${ARGUMENTS[2]} == ${TENDER}
    tbums.Пошук тендера по ідентифікатору    ${ARGUMENTS[0]}    ${ARGUMENTS[2]}
    Click Element    id=lot-update-btn
...
Отримати інформацію із предмету
    ...
    ${return_value}=    Run Keyword And Return    tbums.Отримати інформацію із тендера    ${username}    ${tender_uaid}    ${field_name}
    [Return]    ${return_value}
...
Отримати інформацію про items[0].deliveryDate.endDate
    ...
    ${return_value}=    tbums_service.convert_date    ${date_value}
    [Return]    ${return_value}
